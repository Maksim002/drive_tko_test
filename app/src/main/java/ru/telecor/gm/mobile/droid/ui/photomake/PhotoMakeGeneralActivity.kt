...
class PhotoMakeGeneralActivity : BaseActivity(), PhotoMakeView {
    ...
    companion object {
        ...
        fun createIntent(activity: Activity, photoPath: String, type: PhotoType, conId: String) =
    ...
    override fun setResultAndFinish() {
        try {
            ...
            presenter.onPhotoDone(photoFile, intent.getStringExtra(PHOTO_CON_ID).toString())
        }catch (e: Exception){
            Timber.e(e)
            showMessage(getString(R.string.error_base))
        }
